...
- [ ] Can you identify whether your Mac has an Intel or M-chip, and explain why it matters for Java?
- [ ] Can you configure Git with your name and email using `git config`?
- [ ] Can you clone a public GitHub repository to your Mac using the terminal?
